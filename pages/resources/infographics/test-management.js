...
export default function TestMGT({ TestmgtApi }) {
            ...
            <div className="cardlist">
                <div className='container'>
                    <div className="row">
                        ...
                        {TestmgtApi.data.resourceCat.resources.nodes.map((item) => (
...
export async function getStaticProps() {
    const TestMgtList = await fetch(`${BASEPATH}graphql`,
        {
            method: 'POST',
    ...
    const TestmgtApi = await TestMgtList.json();

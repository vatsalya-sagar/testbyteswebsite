...
export default function Gametesting({ GameTestingList }) {
    console.log("GameTestingList", GameTestingList)
    return (
        <>
            ...
            <div className="cardlist">
                <div className='container'>
                    <div className="row">
                        ...
                        {GameTestingList.data.resourceCat.resources.nodes.map((item) => (
...
export async function getStaticProps() {
    ...
    const GameTestingList = await GameTesting.json();
